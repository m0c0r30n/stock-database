    ...
    <div class="indexes">
      <div class="nikkei_content">
        ...
        <div class="nikkei_info">
          <p>前日値</p><span class="price">{{ $nikkei_pastprice }}円</span>
          <p>始値</p><span class="price">{{ $nikkei_datas["openprice"] }}円</span>
          <p>終値 </p><span class="price">{{ $nikkei_datas["endprice"] }}円</span>
        </div>
      </div>
      <div class="mothers_content">
        ...
        <div class="mothers_info">
          <p>前日値</p><span class="price">{{ $mothers_pastprice }}円</span>
          <p>始値</p><span class="price">{{ $mothers_datas["openprice"] }}円</span>
          <p>終値</p><span class="price">{{ $mothers_datas["endprice"] }}円</span>
        </div>
      </div>
    </div>
