    ...
    <div class="indexes">
      <div class="nikkei_content">
        ...
        <div class="nikkei_info">
          ...
          <div class="margin-left"><p>始値</p><span class="price">{{ $nikkei_datas["openprice"] }}円</span></div>
          <div class="margin-left"><p>終値</p><span class="price">{{ $nikkei_datas["endprice"] }}円</span></div>
        </div>
      </div>
      <div class="mothers_content">
        ...
        <div class="mothers_info">
          ...
          <div class="margin-left"><p>始値</p><p class="price">{{ $mothers_datas["openprice"] }}円</p></div>
          <div class="margin-left"><p>終値</p><p class="price">{{ $mothers_datas["endprice"] }}円</p></div>
        </div>
      </div>
    </div>
