<div class="box">
    ...
    <div class="box-header with-border">
		...
		<a href="{{url('admin/s3fileup')}}"><input class="btn-sm" style="margin-right: 10px;background-color:#FCC765;color:white;border:gray;" type="button" id="sendPdf" value="PDFをクラウドに送信"></a>
